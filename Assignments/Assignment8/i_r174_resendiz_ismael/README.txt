...
Output: classified label (result). And index in the dataset corresponding to the image.
...
Testing: main.m
Contains my testing experiments by individual tasks. It requires the Neural Network Add-on in Matlab to plot the confusion matrix and the path './nmist_data' to load the testing data.
