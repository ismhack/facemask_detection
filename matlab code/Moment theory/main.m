...
%% testing central moment classification - takes 3-4 minutes to complete
...
%% testing normalized moment classification takes 3-5 minutes to complete
class = zeros(5000,1) + realmax;
indexes = zeros(5000,1);
...
%% testing hu moments classification takes 3-5 minutes to complete
