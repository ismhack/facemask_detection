...
w = 100;
c = 3; 
imds = imageDatastore('data/cnn', 'LabelSource', 'foldernames', 'IncludeSubfolders',true);
tbl = countEachLabel(imds)
[trainingSet, testSet] = splitEachLabel(imds, .7, 'randomized');
...
tic; [result, boxes] = boosted_detector_skin_demo(test, 1:0.4:3, boosted_classifiers, weak_classifiers, [h, w], positives, negatives,  6); toc;
...
tic; [result, boxes] = boosted_detector_skin_demo(test, 0.5:0.5:3, boosted_classifiers, weak_classifiers, [h, w], positives, negatives,  2); toc;

boxes = facemask_classifier(test, net, boxes);
